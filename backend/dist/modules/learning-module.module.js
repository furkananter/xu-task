...
exports.LearningModuleModule = LearningModuleModule = __decorate([
    (0, common_1.Module)({
        providers: [
            ...
            learning_module_data_service_1.LearningModuleDataService,
            progress_service_1.ProgressService,
        ],
        exports: [learning_module_data_service_1.LearningModuleDataService, progress_service_1.ProgressService],
    })
