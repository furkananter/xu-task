...
exports.LearningModuleResolver = void 0;
...
let LearningModuleResolver = class LearningModuleResolver {
    repository;
    progressService;
    constructor(repository, progressService) {
    ...
    toggleModuleCompletion(input) {
        return this.repository.updateCompletion(input.id, input.completed);
    }
    getProgress() {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.ToggleCompletionInput]),
...
__decorate([
    (0, graphql_1.Query)(() => learning_module_model_1.ProgressStatsType, { name: 'progress' }),
    __metadata("design:type", Function),
...
exports.LearningModuleResolver = LearningModuleResolver = __decorate([
    ...
    __metadata("design:paramtypes", [learning_module_repository_1.LearningModuleRepository,
